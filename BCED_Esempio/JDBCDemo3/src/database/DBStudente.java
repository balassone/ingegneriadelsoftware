...
public class DBStudente {
	...
	private ArrayList<DBBadge> badge;
	...
	public DBStudente() {
		...
		this.badge = new ArrayList<DBBadge>();
	}
	...
	public void caricaBadgeStudenteDaDB() {
		...
		try {
			...
			while(rs1.next()) {
				...
				this.badge.add(badge); //NON DIMENTICARE DI SALVARE IL RISULTATO
	...
	public int SalvaInDB(String matricola) {
		
		int ret = 0;
		
		String query = "INSERT INTO studenti(matricola,nome,cognome,nascita) VALUES ( \'"+matricola+"\',"+"\'"+this.nome+"\','"+this.cognome+"\','"+this.dataNascita+"')"; 
	...
	public ArrayList<DBBadge> getBadge() {
		return badge;
	}

	public void setBadge(ArrayList<DBBadge> badge) {
		this.badge = badge;
	}
